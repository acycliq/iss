...
*														*
********************************************************/
//var mapChart = dc.pieChart("#dc-map-graph");
...
/********************************************************
*														*
* 	Step2: Create d3 Objects& Load json file			*
*														*
********************************************************/
...
********************************************************/
	...
	var businessDimensionGroup = businessDimension.group().reduce(
		//add
		function(p,v){
		...
		//init
		function(p,v){
			return {latitude:0, longitude: 0, review_count: 0, stars:0, name:'', city:''};
		}
	);
