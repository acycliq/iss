...
// initialize scales
const xScale = d3.scaleLinear().domain([extent.x[0] - 100, extent.x[1] + 100]).range([0, plotAreaWidth]);
const yScale = d3.scaleLinear().domain([extent.y[0] - 100, extent.y[1] + 100]).range([plotAreaHeight, 0]);
...
function updateScales(data) {
  ...
  scale.x.domain([extent.x[0] - 500, extent.x[1] + 500]);
  scale.y.domain([extent.y[0] - 500, extent.y[1] + 500]);
}
